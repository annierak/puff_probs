...
sim_time = 100*60.
puff_x_vel,puff_y_vel =1.,0. #current setup with puff release_rate requires these >=1.
puff_r_sq = .5
puff_buffer_time = xmax/puff_x_vel
stop_puffs = False

num_flies = 1000
fly_velocity = np.array([0.,-2.])
...
flies1 = Flies(fly_x_0,fly_y_0,fly_velocity,False,ampl_const,puffs,detection_threshold,use_grid=False)
flies2 = Flies(np.copy(fly_x_0),np.copy(fly_y_0),fly_velocity,True,ampl_const,puffs,detection_threshold,use_grid=True)
